...
style.textContent = `[data-d4-row-mode] #app > .aheart-tree{block-size:320px;max-block-size:320px;overflow-y:auto;}[data-d4-row-mode] .aheart-tree-select__panel [role="tree"]{block-size:256px;max-block-size:256px;overflow-y:auto;}[data-d4-row-mode="coarse"] .aheart-tree__node,[data-d4-row-mode="coarse"] .aheart-cascader__option{min-block-size:44px;}[data-d4-row-mode="dynamic"] .aheart-tree__node,[data-d4-row-mode="dynamic"] .aheart-cascader__option{white-space:normal;}[data-d4-row-mode="dynamic"] .aheart-tree__title,[data-d4-row-mode="dynamic"] .aheart-cascader__option > span{white-space:normal;line-height:1.5;inline-size:160px;max-inline-size:160px;flex:0 1 160px;overflow-wrap:anywhere;}`
