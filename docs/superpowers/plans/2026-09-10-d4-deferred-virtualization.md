...
- [x] Frozen code candidate full repository gates, generated outputs and zero new skips: unit 1431/79/200/232 after both PR CI portability guards, E2E 808 passed/127 existing skips/0 failed, skip-site delta 0.
