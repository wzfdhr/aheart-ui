...
- [x] Frozen code candidate full repository gates, generated outputs and zero new skips: unit 1431/79/200/231 after the PR CI portability guard, E2E 808 passed/127 existing skips/0 failed, skip-site delta 0.
