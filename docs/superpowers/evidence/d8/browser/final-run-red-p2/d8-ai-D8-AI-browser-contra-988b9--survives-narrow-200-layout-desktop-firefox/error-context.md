...
- Name: d8-ai.spec.ts >> D8 AI browser contract >> tool summary is whitelist-only and iframe owner-document cleanup survives narrow 200% layout
- Location: e2e/d8-ai.spec.ts:190:7
  ...
  - generic [ref=e109]:
        ...
        - iframe [active] [ref=e220]:
          - generic [ref=f1e3]:
            ...
            - generic [ref=f1e109]:
              ...
              - main [ref=f1e118]:
                - generic [ref=f1e121]:
                  - generic [ref=f1e122]: iframe ready
                  - button "卸载" [active] [ref=f1e123] [cursor=pointer]
                  - status [ref=f1e124]: "1"
              - contentinfo [ref=f1e125]:
                - paragraph [ref=f1e128]:
                  - text: "最后更新:"
                  - time [ref=f1e129]: 8/12/26, 6:46 PM
                - navigation "Pager" [ref=f1e130]:
                  - generic [ref=f1e131]: Pager
                  - link "上一页 AIForm AI 智能表单" [ref=f1e133] [cursor=pointer]:
                    - /url: /components/ai-form.html
                    - generic [ref=f1e134]: 上一页
                    - generic [ref=f1e135]: AIForm AI 智能表单
    - contentinfo [ref=e221]:
      ...
      - navigation "Pager" [ref=e226]:
        ...
        - link "上一页 AIForm AI 智能表单" [ref=e229] [cursor=pointer]:
          - /url: /components/ai-form.html
