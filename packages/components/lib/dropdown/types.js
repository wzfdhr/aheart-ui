...
const types = require("../button/types.js");
const dropdownProps = {
  menu: Object,
  trigger: {
    type: Array,
...
const dropdownButtonProps = {
  ...
  type: {
    type: String,
    default: "default",
    validator: (value) => types.buttonTypes.includes(value)
  },
  size: {
    type: String,
    validator: (value) => types.buttonSizes.includes(value)
  },
  nativeType: {
    type: String,
    default: "button",
    validator: (value) => types.nativeButtonTypes.includes(value)
  },
  htmlType: {
    type: String,
    validator: (value) => types.nativeButtonTypes.includes(value)
