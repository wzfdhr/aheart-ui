...
const TypographyRenderNode = vue.defineComponent({
...
const useTypographyCopyable = (copyable, contentRef, disabled) => {
  ...
  const copyableConfig = vue.computed(() => getCopyableConfig(copyable.value));
  const isCopyable = vue.computed(() => Boolean(copyableConfig.value));
  const copyTabIndex = vue.computed(() => {
    var _a;
    return ((_a = copyableConfig.value) == null ? void 0 : _a.tabIndex) ?? 0;
  });
  const copyIcon = vue.computed(() => {
    var _a;
...
exports.TypographyRenderNode = TypographyRenderNode;
exports.useTypographyCopyable = useTypographyCopyable;
