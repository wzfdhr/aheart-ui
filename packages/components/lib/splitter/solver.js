...
const resolveValue = (value, containerSize, fallback) => {
...
const resolveSplitterPanelBounds = (panel, containerSize = 0) => ({
  min: Math.max(0, resolveValue(panel == null ? void 0 : panel.min, containerSize ?? 0, 0)),
  max: Math.max(0, resolveValue(panel == null ? void 0 : panel.max, containerSize ?? 0, Number.POSITIVE_INFINITY))
});
const redistribute = (sizes, panels, containerSize) => {
...
exports.resizeAdjacentPanels = resizeAdjacentPanels;
exports.resolveSplitterPanelBounds = resolveSplitterPanelBounds;
exports.resolveSplitterSizes = resolveSplitterSizes;
