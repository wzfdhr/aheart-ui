import { shallowRef, computed, watch, onScopeDispose } from "vue";
import { createTreeIndex } from "./tree-index.js";
...
function useTreeLoader(source, getLoader, disabled) {
  const patches = shallowRef(/* @__PURE__ */ new Map());
  const loadingKeys = shallowRef(/* @__PURE__ */ new Set());
  const errorKeys = shallowRef(/* @__PURE__ */ new Set());
