import { defineComponent, ref, computed, onMounted, nextTick, watch, onBeforeUnmount, openBlock, createElementBlock, normalizeClass, normalizeStyle, Fragment, renderList, renderSlot, createCommentVNode } from "vue";
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        virtualMode.value ? (openBlock(), createElementBlock("div", {
          key: 0,
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row) => {
            return openBlock(), createElementBlock("div", {
              ...
              style: normalizeStyle(rowStyle(row.item)),
              ref_for: true,
        ...
        ], 4)) : !virtualMode.value ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(__props.items, (option, index) => {
          return openBlock(), createElementBlock("div", {
