import { defineComponent, ref, getCurrentInstance, computed, openBlock, createElementBlock, normalizeClass, createElementVNode, toDisplayString, withDirectives, vModelText, createCommentVNode, createVNode, unref } from "vue";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["aheart-tree-select", { "is-open": open.value, "is-disabled": __props.disabled }])
      }, [
