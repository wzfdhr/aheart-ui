...
const reorder = require("@atlaskit/pragmatic-drag-and-drop/reorder");
...
function moveSortableItem(source, targetListId, targetIndex) {
  ...
  if (source.listId === targetListId) {
    ...
    targetController.update(reorder.reorder({ list: targetItems, startIndex: source.index, finishIndex }));
...
exports.moveSortableItemToAdjacentList = moveSortableItemToAdjacentList;
