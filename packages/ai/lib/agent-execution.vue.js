        ...
        vue.createElementVNode("section", {
          ...
          vue.createElementVNode("div", _hoisted_2, [
            vue.createElementVNode("div", null, [
              _cache[0] || (_cache[0] = vue.createElementVNode("span", { class: "aheart-ai-workbench__eyebrow" }, "执行流程", -1)),
                  ...
                  return [
                    vue.createElementVNode("article", {
                      ...
                      vue.createElementVNode("div", _hoisted_5, [
                        vue.createElementVNode("header", _hoisted_6, [
                          vue.createElementVNode("div", null, [
                            vue.createElementVNode("strong", null, vue.toDisplayString(asTask(item).label), 1),
                            asTask(item).toolName ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_7, vue.toDisplayString(asTask(item).toolName), 1)) : vue.createCommentVNode("", true)
                          ]),
                          vue.createElementVNode("span", _hoisted_8, vue.toDisplayString(statusLabel(asTask(item).status)), 1)
                        ]),
                        asTask(item).detail ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_9, vue.toDisplayString(asTask(item).detail), 1)) : vue.createCommentVNode("", true),
                        asTask(item).progress !== void 0 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_10, [
                        ...
                        asTask(item).startedAt || asTask(item).completedAt ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_12, [
                          asTask(item).startedAt ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_13, "开始 " + vue.toDisplayString(asTask(item).startedAt), 1)) : vue.createCommentVNode("", true),
                          asTask(item).completedAt ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_14, "完成 " + vue.toDisplayString(asTask(item).completedAt), 1)) : vue.createCommentVNode("", true)
                        ])) : vue.createCommentVNode("", true),
                        asTask(item).error ? (vue.openBlock(), vue.createElementBlock("details", _hoisted_15, [
                        ...
                        asTask(item).approval ? (vue.openBlock(), vue.createElementBlock("div", {
                          ...
                          vue.createElementVNode("div", null, [
                            ...
                            ((_d = asTask(item).approval) == null ? void 0 : _d.description) ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_18, vue.toDisplayString((_e = asTask(item).approval) == null ? void 0 : _e.description), 1)) : vue.createCommentVNode("", true)
                          ]),
                          ...
                          ], 64)) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_19, vue.toDisplayString(((_h = asTask(item).approval) == null ? void 0 : _h.status) === "approved" ? "已批准" : "已拒绝"), 1))
          ...
          !__props.tasks.length ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_20, "尚无执行任务。")) : vue.createCommentVNode("", true)
        ]),
        vue.createElementVNode("section", {
          ...
          vue.createElementVNode("div", _hoisted_21, [
            vue.createElementVNode("div", null, [
              _cache[9] || (_cache[9] = vue.createElementVNode("span", { class: "aheart-ai-workbench__eyebrow" }, "产物输出", -1)),
          ...
          __props.artifacts.length ? (vue.openBlock(), vue.createElementBlock("ul", _hoisted_22, [
              ...
              return vue.openBlock(), vue.createElementBlock("li", {
                ...
                vue.createElementVNode("button", {
                  ...
                  vue.renderSlot(_ctx.$slots, "artifact", { artifact }, () => [
                    ...
                    artifact.description ? (vue.openBlock(), vue.createElementBlock("small", _hoisted_25, vue.toDisplayString(artifact.description), 1)) : vue.createCommentVNode("", true)
                  ])
                ], 8, _hoisted_24)
              ], 10, _hoisted_23);
            }), 128))
          ])) : (vue.openBlock(), vue.createElementBlock("p", _hoisted_26, "任务完成后，产物会出现在这里。")),
          selectedArtifact.value ? (vue.openBlock(), vue.createElementBlock("section", _hoisted_27, [
            vue.renderSlot(_ctx.$slots, "artifact-preview", { artifact: selectedArtifact.value }, () => [
              vue.createElementVNode("div", _hoisted_28, [
                ...
                vue.unref(safeMarkdown.getSafeUrl)(selectedArtifact.value.url) ? (vue.openBlock(), vue.createElementBlock("a", {
                  ...
                  target: "_blank",
                  rel: "noreferrer"
                }, "打开产物", 8, _hoisted_29)) : vue.createCommentVNode("", true)
              ]),
              vue.createElementVNode("p", null, vue.toDisplayString(selectedArtifact.value.description ?? "业务层可通过 artifact-preview 插槽提供自定义预览。"), 1),
              selectedArtifact.value.updatedAt ? (vue.openBlock(), vue.createElementBlock("small", _hoisted_30, "更新于 " + vue.toDisplayString(selectedArtifact.value.updatedAt), 1)) : vue.createCommentVNode("", true)
            ])
          ])) : vue.createCommentVNode("", true)
        ])
      ]);
