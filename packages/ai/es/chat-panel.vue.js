import { defineComponent, ref, computed, watch, openBlock, createElementBlock, createElementVNode, Fragment, renderList, createBlock, createVNode, toDisplayString } from "vue";
import _sfc_main$1 from "./bubble.vue.js";
import _sfc_main$2 from "./sender.vue.js";
const _hoisted_1 = {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    const workingMessages = ref([...props.messages]);
    const draft = ref("");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1, [
        ...
        createElementVNode("p", _hoisted_3, toDisplayString(announcement.value), 1)
      ]);
    };
  }
});
